...
@section('content')
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="get-map-info" action="get-map-info" method="get">
                    ...
                    <input type="text" name="user_location_lat" size="50"><br>
                    <input type="text" name="user_location_lng" size="50"><br>
    ...
    <script type="text/javascript">
        $.get("http://freegeoip.net/json/", function (response) {
            $('input[name="user_location_lat"]').val(response.latitude);
            $('input[name="user_location_lng"]').val(response.longitude);
        }, "jsonp");    </script>
    <script async defer
